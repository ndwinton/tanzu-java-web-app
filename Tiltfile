...
custom_build('harbor-repo.vmware.com/tanzu_desktop/tanzu-java-web-app',
...
tanzu_k8s_yaml('tanzu-java-web-app', 'harbor-repo.vmware.com/tanzu_desktop/tanzu-java-web-app', './config/workload.yaml')
